...
// copy from https://github.com/weijiekoh/poseidon-encryption-circom/blob/master/circom/poseidon.circom

include "circomlib/circuits/poseidon_constants.circom";
